	...
	<div class="col-lg-12">
		<div class="card">
			<div class="card-header d-flex justify-content-between align-items-center">
				...
				<a class="btn btn-primary btn-sm float-right" href="{{ route('client.loans.apply_loan') }}"><i class="icofont-plus-circle"></i> {{ _lang('Apply Loan') }}</a>
			</div>
			...
			<div class="card-body">
				<table id="loans_table" class="table table-bordered data-table">
					...
					<tbody>
                        ...
                        <tr>
                            <td><a href="{{ route('client.loans.loan_details',$loan->id) }}">{{ $loan->loan_id }}</a></td>
