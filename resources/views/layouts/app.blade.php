    ...
    <body class="sb-nav-fixed">
		...
		<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <div class="container-fluid">
				{{-- <a class="navbar-brand text-md-center" href="{{ route('adminDashboard.index') }}">{{ get_option('site_title', config('app.name')) }}</a> --}}
                ...
                <nav class="sb-sidenav accordion sb-sidenav-light" id="sidenavAccordion">
					...
					<div class="sidebar-user">
                        <a href="javascript: void(0);">
                            {{-- <img src="{{ profile_picture(Auth::user()->profile_picture) }}" alt="user-image" height="42" class="rounded-circle shadow-sm"> --}}
					...
					<div class="sb-sidenav-menu">
                        <div class="nav">
                            @include('layouts.menus.'.auth()->user()->role->name)
                        </div>
                    </div>
                </nav>
        ...
        <!-- App js -->
        <script src="{{ asset('/backend/assets/js/scripts.js?v=1.2') }}"></script>
